...
*** TODO cache engine initialisation
      - can't set BPM, pulse, time-signature, etc during initialisation (i.e. before first play)
      - check node/worklet initialisation for 'null' track 

*** TODO fix
```
playlist.js:674 Uncaught (in promise) TypeError: Cannot read properties of null (reading 'findIndex')
    at playlist.js:674:38
(anonymous) @     playlist.js:674
Promise.then            
#dragover   @     playlist.js:670
```
...
*** TODO 'dings' (cf. https://github.com/transcriptaze/yam/issues/9)
**** TODO better ding sample
**** DONE ding enable/disable icon
**** DONE sort dings by measure/beat
**** TODO (?) replace click with ding rather than play simultaneously
