...
*** DONE replace animationFrame with 'click' event
*** DONE time signature number picker is too small on mobile
...
**** DONE volume setting
**** DONE logarithmic gain
**** DONE store sample in IndexedDB
**** DONE query DB for click
**** TODO get click from DB
**** TODO deleteTrack
