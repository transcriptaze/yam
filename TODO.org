...
*** DONE playlists '+'' floating button is visually confusing
*** DONE (temporarily) remove eighth note pulse
*** DONE lock tempo
*** DONE MM disappears after tap + locked
*** DONE time signature common time is being picked as 4:4
...
**** DONE fix time signature defval
**** DONE time signature none
**** DONE lowlight empty section fields (name, role)
**** TODO toggle measures input between header and subsections
**** TODO display subsections
**** TODO slide in on initialisation
**** TODO enable editor save iff changed

*** TODO clicks
**** DONE use section clicks in worklet
**** TODO 'ding'
      - https://github.com/transcriptaze/yam/issues/9
      - use sample map for metronome constructor
...
*** TODO expand single section
      - hover >> arrow maybe (doesn't work on mobile)
