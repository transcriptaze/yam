...
*** TODO save while playing resets track

*** TODO track editor
**** DONE lowlight empty section fields (name, role)
**** DONE don't lowlight = if both pulse and BPM are default
...
**** TODO optimize: schedule dings on load/start and remove from list when played
**** TODO optimize: sort scheduled dings by measure/beat
