...
*** DONE can't edit new track
*** DONE toolbar edit icon is visible after track deleted
...
**** DONE remove up/down arrows in editor BPM
**** DONE editor: loop count font

*** TODO fix about box layout
