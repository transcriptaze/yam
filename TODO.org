...
**** DONE get click from DB
**** DONE deleteTrack
**** DONE version check + upgrade
**** TODO settings: soundset
**** TODO settings: per sample volume
...
**** TODO display subsections
      - can't edit section measures if role/name is blank ??
...
```
{
    "message": "Uncaught TypeError: Cannot read properties of undefined (reading 'pulse')",
    "source": "https://yam-8sz.pages.dev/javascript/widgets/editor.js",
    "lineno": 308,
    "colno": 24,
    "error": {}
}
