...
*** TODO reset :hover style
*** TODO reset UI if selected track is removed from playlist
      - UI is reset but saving after delete only adds the new track to 'All Tracks'

*** TODO section pulse: need a way to revert to '' (default)
**** DONE add '' pulse to popup list
**** DONE defval for 'none' img
**** TODO separate MM web comoponent for sections
**** TODO fix MM popover div/ul/li thing
**** TODO fix defval - should inherit from previous section
**** TODO don't fire change if pulse is ''
**** TODO display equals iff pulse and BPM are defined
...
**** TODO MM/time signature popover
**** TODO editor section layout
...
*** TODO (?) use microtasks for engine initialisation
      - https://developer.mozilla.org/en-US/docs/Web/API/HTML_DOM_API/Microtask_guide
*** TODO automatically add clicks to new pickup and count-in sections
*** TODO editor: enable/disable button iff there are changes
*** TODO different grip icon
*** TODO 'tack.wav' for e.g. 5:4c
*** TODO spacebar in editor starts/stops metronome
...
*** TODO change toggle to start/stop
