...
*** TODO loop count
**** DONE editor
**** DONE loop count badge
**** DONE count-down
**** TODO fix colours

*** TODO add new track
**** DONE fix playlist weirdness if new track is added to selected+closed playlist
**** TODO set editor track
**** TODO update open tracklist widget

*** TODO clear current track
**** TODO on selecting another playlist
