...
*** DONE allow BPM changes while playing a track
*** DONE changing pulse/time-signature etc 'waits' for click
*** DONE BPM changes scaled by track BPM
*** DONE wait for metronome to start before enabling 'stop' (confusing double click)
*** DONE update worklet track on editor::save
*** DONE use sample map for metronome constructor
*** DONE remove Track.addEventListener
*** DONE updated widgets on new/save track
*** DONE save while playing resets track
*** DONE worklet not using section BPM
*** DONE cache engine initialisation
*** DONE default section name not displayed in info
*** DONE playlist.js:674:38 Uncaught (in promise) TypeError: Cannot read properties of null (reading 'findIndex')
*** DONE 'dings' (cf. https://github.com/transcriptaze/yam/issues/9)
*** DONE pads for 3:8, 6:8, 9:8 and 12:8, dotted-quarter
*** DONE BPM wheel (landscape) not updating MM
*** DONE figura wheel (cf. https://github.com/transcriptaze/yam/issues/13)
*** DONE progress bar not being reset on stopped
*** DONE reset not clearing track

*** TODO tactus wheel (cf. https://github.com/transcriptaze/yam/issues/12)
**** TODO svg
**** TODO replace tactus input
**** TODO yam-time-signature
**** TODO yam-section-time-signature
**** TODO Bravura font

*** TODO track editor (cf. https://github.com/transcriptaze/yam/issues/2)
**** DONE expand single section
**** DONE slide in on initialisation
**** DONE section time signature popup at bottom of list is unusable
**** DONE section time signature not saving tactus/figura
