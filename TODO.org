...
*** TODO coloured subsections (cf. https://github.com/transcriptaze/yam/issues/8)
**** DONE render coloured subsections
**** DONE use track.section.subsections
**** DONE FIXME stop can be (mistakenly and/or temporarily) greater than 1 because value and bars are set independently
**** TODO FIXME use gradient function
**** TODO don't do the gradient blend thing at end/start of subsections
**** TODO (?) paint subsections 'inside' bar (e.g. 1px margin at top/bottom.left,right)

*** TODO '+' button on playlists (cf. https://github.com/transcriptaze/yam/issues/14)
**** DONE popup
**** TODO list tracks not in playlist
**** TODO 'new' track
**** TODO automatically create new track in editor for All Tracks
**** TODO check edit dismiss actually works

*** TODO track editor (cf. https://github.com/transcriptaze/yam/issues/2)
**** DONE enable editor save iff changed
**** DONE fix save error
**** DONE display subsections
**** DONE subsection measures not updated from section measures
**** TODO display subsection BPM (calculated)
      - copy track tempo/BPM down to subsections
      - field-sizing: content
**** TODO (?) section measures not editable after expand-collapse
**** TODO slide-in sections list
...
*** TODO make errors visible (cf. https://github.com/transcriptaze/yam/issues/38)
      - title text
      - message box
      - icon is too close to right edge
